#
# list = ['\n                        ', '\n\t\t\t\t\t\t占地六万多平方米，背靠云门山，毗邻明代古长城及奇异怪坡,九龙温泉度假村周边郁郁葱葱，一片美丽的田园风光,走进度假村，欧式风格建筑，蓝天净土、绿树成荫,亭台楼阁、绿色蔬园，真可谓典雅宁静的自然氧吧\n                    ']
# print(list[1].strip())
...
if __name__ == "__main__":
    if not os.path.exists('./景点图片库'):
        os.mkdir('./景点图片库')
    #爬取页面源码数据
    url = 'http://s.lvmama.com/ticket/K653100P19?'
    headers = {
        'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.135 Safari/537.36'
    }
    count = 0
    fp1 = open('./info_1.txt', 'w', encoding='utf-8')
    param = {
